...
.hero::before {
  ...
  right: 0;
  bottom: 0;
  background: radial-gradient(circle at 20% 30%, rgba(155, 89, 182, 0.15) 0%, transparent 60%),
...
.hero-nav .nav-link:hover::before {
  left: 0;
}
...
.mechanic-features .feature-item {
  display: flex;
